...
exports.CommunicationError =
  ...
  exports.Utils =
  exports.AssetType =
  exports.AssetVersion =
  exports.TxsStatus =
    void 0;
// Import the Network module from the current directory's network file
const ErrorsAndExcepts_1 = require('./ErrorsAndExcepts');
...
})(TxsStatus || (exports.TxsStatus = TxsStatus = {}));
...
})(AssetVersion || (exports.AssetVersion = AssetVersion = {}));
...
class WalletSdk {
  ...
  constructor(
    ...
    this._currentWorkType = (0, network_1.getNetworks)(
      this._currentWorkTypeName,
    );
    this._conn = false;
  }
  /**
  ...
  checkConnection() {
    if (!WalletSdk.installed()) {
      throw new ErrorsAndExcepts_1.BitTapError(
        'BittapWalletInjected not installed',
      );
    }
    if (!this._conn) {
      throw new ErrorsAndExcepts_1.BitTapError('Bittap Wallet not connected');
    }
  }
  /**
        ...
        this._walletProvider.sendRequestJsBridge({
          ...
          callback: res => {
            if (
              ...
              throw new ErrorsAndExcepts_1.RejectError('connectionWallet');
            }
  ...
  switchNetwork(_network, url) {
    return new Promise((resolve, reject) => {
      ...
      if (!_network) {
        throw new ErrorsAndExcepts_1.NetworkUnavailableError(
  ...
  setOnListenTransactionStatusHandler(func) {
    ...
    if (typeof func === 'function') {
      ...
      throw new ErrorsAndExcepts_1.BitTapError('func is not a function');
    }
  }
  /**
        ...
        this._walletProvider.sendRequestJsBridge({
          ...
          callback: res => {
            if (
              ...
              throw new ErrorsAndExcepts_1.RejectError('getCurrentAssets');
            }
        ...
        this._walletProvider.sendRequestJsBridge({
          ...
          callback: res => {
            if (
              ...
              throw new ErrorsAndExcepts_1.RejectError('getInvoices');
            }
        ...
        this._walletProvider.sendRequestJsBridge({
          ...
          callback: res => {
            if (
              ...
              throw new ErrorsAndExcepts_1.RejectError('createInvoice');
            }
            resolve(res.data);
          },
          reject: res => {
    ...
    return new Promise((resolve, reject) => {
      try {
        ...
        if (!_opts.asset_id && !_opts.asset_name) {
          ...
          throw new ErrorsAndExcepts_1.BitTapError(
            'asset_id or asset_name is required',
          );
        }
        ...
        this._walletProvider.sendRequestJsBridge({
          ...
          callback: res => {
            if (
              ...
              throw new ErrorsAndExcepts_1.RejectError('searchAssets');
            }
  ...
  addListenTxId(txIds) {
    this.checkConnection();
    if (txIds.length === 0) {
      throw new ErrorsAndExcepts_1.BitTapError('txIds is required');
    }
    if (
      !this._onListenTransactionHandler ||
      typeof this._onListenTransactionHandler !== 'function'
    ...
    if (txIds.some(txId => !Utils.isTxId(txId))) {
      throw new ErrorsAndExcepts_1.BitTapError('Invalid txid.');
    }
    this._walletProvider.sendRequestJsBridge({
      client_id: this._provider.client_id,
      type: 'addListenTxId',
    ...
    return new Promise((resolve, reject) => {
      try {
        if (!_opts.recv_addr && !_opts.amount) {
          throw new ErrorsAndExcepts_1.BitTapError(
            'recv_addr or amount is required',
          );
        }
        // @ts-ignore
        ...
        this._walletProvider.sendRequestJsBridge({
          ...
          callback: res => {
            if (
              ...
              throw new ErrorsAndExcepts_1.RejectError('transferBtc');
            }
            resolve(res.data);
          },
          reject: res => {
    ...
    return new Promise((resolve, reject) => {
      try {
        if (!_opts.receive_addr) {
          throw new ErrorsAndExcepts_1.BitTapError('receive_addr is required');
        }
        // @ts-ignore
        _opts.fee_rate = Math.max(Math.floor(_opts.fee_rate), 1);
        this._walletProvider.sendRequestJsBridge({
          ...
          callback: res => {
            if (
              ...
              throw new ErrorsAndExcepts_1.RejectError('sendTaprootAssets');
            }
            resolve(res.data);
          },
          reject: res => {
  ...
  async signMessage(_msg) {
    ...
    return new Promise((resolve, reject) => {
      try {
        if (!_msg) {
          throw new ErrorsAndExcepts_1.BitTapError('_msg is required');
        }
        this._walletProvider.sendRequestJsBridge({
          client_id: this._provider.client_id,
          type: 'signMessage',
          ...
          callback: res => {
            if (
              ...
              throw new ErrorsAndExcepts_1.SignatureFailedError('signMessage');
            }
...
Object.defineProperty(exports, 'NetworkType', {
  enumerable: true,
  get: function () {
    return network_2.NetworkType;
  },
});
Object.defineProperty(exports, 'getNetworks', {
  enumerable: true,
  get: function () {
    return network_2.getNetworks;
  },
});
// Export the BitTapError class
var ErrorsAndExcepts_2 = require('./ErrorsAndExcepts');
Object.defineProperty(exports, 'BitTapError', {
  enumerable: true,
  get: function () {
    return ErrorsAndExcepts_2.BitTapError;
  },
});
Object.defineProperty(exports, 'AssetNotFoundError', {
  enumerable: true,
  get: function () {
    return ErrorsAndExcepts_2.AssetNotFoundError;
  },
});
Object.defineProperty(exports, 'InvalidBTCAddressError', {
  enumerable: true,
  get: function () {
    return ErrorsAndExcepts_2.InvalidBTCAddressError;
  },
});
Object.defineProperty(exports, 'InsufficientAssetsError', {
  enumerable: true,
  get: function () {
    return ErrorsAndExcepts_2.InsufficientAssetsError;
  },
});
Object.defineProperty(exports, 'NetworkUnavailableError', {
  enumerable: true,
  get: function () {
    return ErrorsAndExcepts_2.NetworkUnavailableError;
  },
});
Object.defineProperty(exports, 'SignatureFailedError', {
  enumerable: true,
  get: function () {
    return ErrorsAndExcepts_2.SignatureFailedError;
  },
});
Object.defineProperty(exports, 'UnknownError', {
  enumerable: true,
  get: function () {
    return ErrorsAndExcepts_2.UnknownError;
  },
});
Object.defineProperty(exports, 'CommunicationError', {
  enumerable: true,
  get: function () {
    return ErrorsAndExcepts_2.CommunicationError;
  },
});
